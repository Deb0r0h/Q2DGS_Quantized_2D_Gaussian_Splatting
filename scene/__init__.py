...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_quant=True):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            print("LEN DI TEST CAMERAS",len(scene_info.test_cameras))
            print("LEN TRAIN CAMERAS",len(scene_info.train_cameras))
            print("DEBAG EVAL PATH", args.eval)
